...
echo "================================"
echo "Installing PostgreSQL event triggers for CREATE and DROP TABLE..."
...
echo ""
echo "✅ Auto-mirror triggers installed!"
echo ""
echo "The following triggers are now active:"
echo "  • CREATE TABLE → Automatically creates mirrors"
echo "  • DROP TABLE   → Automatically drops mirrors"
echo ""
echo "Next steps:"
echo "  1. Start the auto-mirror worker: docker compose up -d auto-mirror-worker"
echo "  2. Create tables in PostgreSQL - mirrors will be created automatically"
echo "  3. Drop tables in PostgreSQL - mirrors will be dropped automatically"
